...
public class IcbcCalendar extends Calendar {
	...
	public String getMonth(){
		int month = cd.get(MONTH)+1;
		return this.prePadding(month);
	}
	public String getDay(){
		return this.prePadding(cd.get(DAY_OF_MONTH));
	}
	public String getHour(){
		return this.prePadding(cd.get(HOUR_OF_DAY));
	}
	public String getMinute(){
		return this.prePadding(cd.get(MINUTE));
	}
	public String getSecond(){
		return this.prePadding(cd.get(SECOND));
	}
	@Override
